...
public class UnassignTaskHandler : IRequestHandler<UnassignTaskCommand, Unit>
{
    private readonly ITaskRepository _taskRepository;
    private readonly IProjectRepository _projectRepository;
    private readonly ICurrentUserService _currentUser;
    public UnassignTaskHandler(ITaskRepository taskRepository, IProjectRepository projectRepository, ICurrentUserService currentUser)
    {
    ...
    public async Task<Unit> Handle(UnassignTaskCommand request, CancellationToken cancellationToken)
    {
        ...
        task.UnAssign(requesterMembership.Role);
